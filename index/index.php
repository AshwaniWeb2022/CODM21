...
<section class="header-wrapper">
    <div style="background-image: url(../assect/upload/herontower2_large.webp);" class="zoominheader">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">Service Cloud is at the heart of personalized service,
                        delivering
                        efficient and connected experiences. It streamlines workflows, automates processes and provides
                        expert support to customer service representatives. With the goal of driving one-to-one
                        marketing
            ...
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">Salesforce leverages APIs for rich platform
                        capabilities and
