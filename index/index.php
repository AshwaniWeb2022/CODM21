...
<section class="section_heading_M-top">
    <div class="container">
        ...
        <h2 class="sub_titel text-center mb-5 mt-2">We offer customised solutions for various industries and ensure
            smooth.</h2>
        <div class="row">
        ...
        <div class="row mb-5">
            ...
            <div class="col-lg-7">
                <div class="ourExpertiseSubTittel text-dark">
                    We're IT specialists delivering tailored Salesforce solutions, from implementation to support, for
                    an optimized CRM experience.
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">Utilizes APIs for robust platform capabilities and
                        seamless cloud service
                        integration, enhancing business agility. By fostering application networks, it promotes
                        flexibility and asset reuse,
                        empowering teams to address evolving business needs. This enables end-users to access vital data
            ...
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">Omnistudio: enabling seamless experiences. Our
                        state-of-the-art
            ...
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    <img src="../assect/upload/home/salesforce-industry-clouds_icon.png" alt="ExpertiseIcon"
                        class="mb-2">
                    <div class="expertiseBoxTitel mb-3 mt-2">Industries Cloud</div>
                    <div class="expertiseBoxSubTitel text-muted">Industries Cloud revolutionizes businesses with
                        customized
                        industry-specific solutions, driving efficiency, innovation and growth. It harnesses the power
                        of
                        Salesforce's advanced technologies and expertise to address the unique challenges and
                        opportunities
            ...
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">The heart of personalized service, delivering efficient
                        and connected experiences. It streamlines workflows, automates processes, and provides expert
                        support to customer service representatives. Aimed at driving one-to-one marketing
                        relationships, it empowers businesses to engage customers across all channels and devices.
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">Our solutions drive profitability by helping companies
                        work smarter,
            ...
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">Experience Cloud, a Salesforce platform, enables
                        personalized
            ...
            <div class="col-lg-4 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">We provide Data Coalition, comprehensive storage, data
                        monitoring
                        and Salesforce data migration services. Salesforce data migration is an important and
                        challenging
            ...
            <div class="col-lg-4 col-md-6 mb-2">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted"> Manufacturing Cloud leverages technologies to provide manufacturers with insights and analytics to optimize operations and profitability. With a user-friendly interface and integration capabilities, this solution enables manufacturers to remain agile while delivering exceptional customer experiences Helps in creating customized solutions as per the need .</div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-2  ">
                <div class="expertiseBox blue">
                    ...
                    <div class="expertiseBoxSubTitel text-muted">Increase sales productivity with our data driven CRM
                        platform. Designed for B2B and B2C contexts,
                        it supports sales, marketing, and customer support. Salesforce Sales Cloud, part of
                        Salesforce.com
                        (SFDC), maximizes the effectiveness of your sales team and drives revenue growth. Increase
                        efficiency
...
<section class="section_heading_M-top" style="background-image:url(../assect/upload/home/contact-us-background.jpg)"
    id="contact_Home">
    <div class="container">
        <div class="p-5">
