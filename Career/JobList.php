    ...
    <div class="job-cards">
     ...
     <div class="job-card-title"><?php echo $blogrow['Career_Tital'];?></div>
      <div class="job-detail-buttons">
       ...
       <button class="search-buttons detail-button"><?php echo $blogrow['Career_WorkLev'];?></button>
      </div> 
      <div class="job-card-buttons">
       <a href="viewJob.php?id=<?php echo $blogrow['id']; ?>" class="search-buttons card-buttons text-center">Apply Now</a>
      </div> 
     </div>
     <?php
       }
      }else {
        echo "<p style='color:red; text-align: center;'>No job available at the moment.</p>";
    }
       ?>
    </div>
   </div>
