...
<h5 class="mb-3 text-center " style="color:#00A1E0;"> Why You Should Join CodM software </h5>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 mb-3">
                <div id="AboutJoiningBenifit">
                    <img src="../assect/upload/career/How to become a certified corporate secretary.jpg" alt="Employee First" class="w-100">
                    <div>Employee First</div>
                    <p>We at CodM believe that employees must be given first preference irrespective of anything. </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mb-3">
                <div id="AboutJoiningBenifit">
                    <img src="../assect/upload/career/25 ways to make every day Fun At Work Day (1).jpg" alt="Fun At Work" class="w-100">
                    <div>Fun At Work</div>
                    <p>Well it’s not just about the work all the time, at CodM we encourage our colleagues to take part
            ...
            <div class="col-lg-3 col-md-4 mb-3">
                <div id="AboutJoiningBenifit">
                    ...
                    <div>Training, Development & Rewards</div>
                    <p>We at CodM provide training on new business insights and focus on development of skills and
...
<section class="mt-5 JobSeekers" style="background-image: url(../assect/upload/career/background4.jpg);">
    <div class="container">
        <h4 class="text-center text-white"> Do you have what it takes to be the best, Then check out our job openings
        </h4>
