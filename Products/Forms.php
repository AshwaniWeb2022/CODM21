...
<section class="F-T-margin-top">
    <div class="container">
        <div class="row ">
            <div class="col-lg-7 mx-auto align-self-center p-md-5 mb-2">
            ...
            <div class="col-lg-5 mx-auto mb-2">
                <img src="../assect/upload/Products/titan_form_1.png" alt="form-1" class="w-100">
            </div>
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-lg-5 mx-auto align-self-center">
                <img src="../assect/upload/Products/titan_form_2.png" alt="form-2" class="w-100">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-4 mx-auto mb-3">
                <img src="../assect/upload/Products/icon-1-1-1.svg" alt="form icon">
                <div class="T-F-no_cod_tital pt-2">No-code Design</div>
                <div class="pt-3 T-F-no_cod_subtital">Get Salesforce forms and custom web portals with Titan’s simple drag and drop builder.</div>
            </div>
            <div class="col-lg-4 mx-auto mb-3">
                <img src="../assect/upload/Products/icon-2-1-1.svg" alt="form icon">
                <div class="T-F-no_cod_tital pt-3">Regulatory Compliant</div>
                <div class="pt-3 T-F-no_cod_subtital">Ensure ultimate compliance with regulatory frameworks, including HIPAA and GDPR.</div>
            </div>
            <div class="col-lg-4 mx-auto mb-3">
                <img src="../assect/upload/Products/icon-4-2.svg" alt="form icon">
                <div class="T-F-no_cod_tital pt-2">End-to-end Secure</div>
                <div class="pt-3 T-F-no_cod_subtital">Secure sensitive organizational data with SalesForce Shield’s end-to-end encryption.</div>
            </div>
        </div>
    </div>
</section>
...
<section class="F-T-margin-top">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 mx-auto align-self-center ">
                <img src="../assect/upload/Products/titan_form-3.png" alt="form-3" class="w-100">
            </div>
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-lg-5 mx-auto align-self-center mb-2">
                <img src="../assect/upload/Products/titan_form-4.png" alt="form-4" class="w-100">
            </div>
        </div>
    </div>
</section>
...
<section class="mt-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 mx-auto align-self-center">
                <img src="../assect/upload/Products/titan_form_5.png" alt="form-5" class="w-100">
            </div>
...
<section class="mt-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 mx-auto align-self-center">
                <img src="../assect/upload/Products/titan_form_6.png" alt="form-6" class="w-100">
            </div>
        </div>
    </div>
</section>
...
<section class="mt-5">
    <div class="container">
    <h2 class="mb-3 sub_titel  text-center"> Titan Forms Features</h2>
        <div class="row pt-4">
