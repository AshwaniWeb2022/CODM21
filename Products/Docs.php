    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 mx-auto align-self-center ">
                <img src="../assect/upload/Products/doc-2.png" alt="form-2" class="w-100">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-lg-7 mx-auto align-self-center  p-md-5">
                ...
                <img src="../assect/upload/Products/Easilygeneratecustom.png" alt="form-1" class="w-100">
            </div>
...
<section class="F-T-margin-top">
    <div class="container">
        <div class="row ">
        <div class="col-lg-5 mx-auto">
                <img src="../assect/upload/Products/doc-6.png" alt="form-1" class="w-100">
            </div>
...
<section class="mt-5">
    <div class="container">
        <h2 class="mb-3 sub_titel  text-center"> Titan Docs Features</h2>
        <div class="row pt-4">
